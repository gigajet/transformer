...
class TransformerDecoderLayer (nn.Module):
    def __init__(self, d_in: int, d_model: int, d_ff: int, d_out: int, n_head: int) -> None:
        super().__init__()
...
if __name__=="__main__":
    ...
    d_model = 512
    my_decoder_layer = TransformerDecoderLayer(d_model, d_model, 2048, d_model, 8)
    ...
    dec = TransformerDecoderLayer(512,512,2048,512,8)
