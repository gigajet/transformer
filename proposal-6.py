...
"""
PROPOSAL 6
FuzzyLayer is inserted after Encoder, before Decoder
"""

class Proposal6Encoder (FairseqEncoder):
...
@register_model('proposal6')
class Proposal6Transformer(FairseqEncoderDecoderModel):
    @staticmethod
    def add_args(parser):
    ...
    def build_model(cls, args, task):
        ...
        model = Proposal6Transformer(encoder, decoder)
        return model

@register_model_architecture('proposal6', 'proposal6_default')
