...
"""
PROPOSAL 8A
FuzzyBlock (with add&norm) is inserted after Embedding, before PositionalEncoding
"""

class Proposal8AEncoder (FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        x = x + self.positional_enc(src_tokens)
...
@register_model('proposal8A')
class Proposal8ATransformer(FairseqEncoderDecoderModel):
    @staticmethod
    def add_args(parser):
    ...
    def build_model(cls, args, task):
        ...
        encoder = Proposal8AEncoder(args.max_src_len,
        ...
        model = Proposal8ATransformer(encoder, decoder)
        return model

@register_model_architecture('proposal8A', 'proposal8A_default')
